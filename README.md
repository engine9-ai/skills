...
| Global message tables | [e9-global-message/SKILL.md](./e9-global-message/SKILL.md) | Read/consume `global_message_summary` (+ `_by_date`): identity, plugin (`bot_*`), engagement, `attributed_*` |
